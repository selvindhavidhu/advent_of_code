if(CMAKE_C_COMPILER_ID STREQUAL "Clang")
    ...
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wall -Wcast-qual -Wextra -Wfloat-equal")
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wformat -Wold-style-cast -Wpedantic")
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wsign-conversion -Wswitch-default -Wno-unknown-pragmas")
    set(CMAKE_C_FLAGS_DEBUG "-g -O0 -Winline")
...
elseif(CMAKE_C_COMPILER_ID STREQUAL "GNU")
    ...
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wformat -Wold-style-cast -Wpedantic")
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wsign-conversion -Wswitch-default -Wno-unknown-pragmas")
    set(CMAKE_C_FLAGS_DEBUG "-g -Og -Winline")
    set(CMAKE_C_FLAGS_RELEASE "-O3 -Werror")
elseif(CMAKE_C_COMPILER_ID STREQUAL "MSVC")
    # /analyze:     Enable native analysis
    # /fsanitize:   Enable address sanitizer codegen
    ...
    set(CMAKE_C_FLAGS "/analyze /fsanitize=address /std:c11 /EHsc /GS /sdl- /W4 /wd\"4996\" /wd\"4458\" /Zi /MP /Gm-")
    set(CMAKE_C_FLAGS_DEBUG "/MDd /Od /RTC1")
    set(CMAKE_C_FLAGS_RELEASE "/GL /MD /O2 /Oi")
else()
    message(FATAL_ERROR "${CMAKE_C_COMPILER_ID} is not recognized.")
endif()